...
import {
  ...
  toggleEsPrecliente,
  toggleEsFacturadora,
} from "@/lib/actions/contactos.actions";
      ...
      <div className="flex flex-wrap justify-center gap-1.5">
        ...
        <button
          ...
          className={[
            ...
            esFacturadora
              ? "border-violet-700 bg-violet-950/60 text-violet-300 hover:bg-violet-950"
              : "border-zinc-600 bg-zinc-800/60 text-zinc-500 hover:bg-zinc-700 hover:text-zinc-300",
          ].join(" ")}
        >
          <Shield className={["h-3 w-3", esFacturadora ? "text-violet-400" : "text-zinc-600"].join(" ")} />
          Matriz
        </button>
        ...
        >
          <span className={["h-1.5 w-1.5 rounded-full", esCliente ? "bg-emerald-400" : "bg-zinc-600"].join(" ")} />
          Cliente
        </button>
        ...
        >
          <span className={["h-1.5 w-1.5 rounded-full", esPrecliente ? "bg-blue-400" : "bg-zinc-600"].join(" ")} />
          Pre-cliente
        </button>
      </div>
